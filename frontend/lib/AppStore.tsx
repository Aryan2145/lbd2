...
function seedGoals(): GoalData[] {
  ...
  return [
    ...
    },
    {
      ...
      notes: [], milestones: [], createdAt: now - 90 * 86_400_000,
    },
    {
      id: "g3",
      ...
      notes: [], milestones: [], createdAt: now - 30 * 86_400_000,
    },
    {
      id: "g4",
      ...
      notes: [], milestones: [], createdAt: now - 120 * 86_400_000,
    },
  ];
}
  ...
  return [
    {
      ...
      type: "binary", target: 1, unit: "", linkedGoalId: "", linkedMilestoneId: "",
    ...
    },
    {
      ...
      type: "binary", target: 1, unit: "", linkedGoalId: "g4", linkedMilestoneId: "",
    ...
    },
    {
      ...
      type: "binary", target: 1, unit: "", linkedGoalId: "g2", linkedMilestoneId: "",
    ...
    },
    {
      ...
      type: "binary", target: 1, unit: "", linkedGoalId: "g1", linkedMilestoneId: "",
    ...
    },
    {
      ...
      type: "measurable", target: 4, unit: "pages", linkedGoalId: "g4", linkedMilestoneId: "",
  ...
  return [
    {
      ...
      lifeArea: "personal", imageUrl: "", targetDate: "2027-01-01",
    ...
    },
    {
      ...
      lifeArea: "health", imageUrl: "", targetDate: "2026-10-01",
    ...
    },
    {
      ...
      lifeArea: "professional", imageUrl: "", targetDate: "2027-01-01",
    ...
    },
    {
      ...
      lifeArea: "spiritual", imageUrl: "", targetDate: "2028-01-01",
    ...
    },
    {
      ...
      lifeArea: "relationships", imageUrl: "", targetDate: "2028-01-01",
    ...
    },
    {
      ...
      lifeArea: "professional", imageUrl: "", targetDate: "2022-01-01",
